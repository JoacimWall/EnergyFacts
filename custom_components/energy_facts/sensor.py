"""Sensor entities for EnergyFacts integration."""
...
from .entity import EnergyFactsEntity
...
async def async_setup_entry(
    ...
    """Set up EnergyFacts sensors from a config entry."""
    coordinator: EnergyFactsCoordinator = hass.data[DOMAIN][entry.entry_id]
...
class EnergyFactsSensor(EnergyFactsEntity, SensorEntity):
    """A EnergyFacts sensor entity."""
...
class EnergyFactsRoiSensor(EnergyFactsEntity, SensorEntity):
...
class EnergyFactsPriceLevelSensor(EnergyFactsEntity, SensorEntity):
