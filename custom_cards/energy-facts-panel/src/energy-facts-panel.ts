...
export class EnergyFactsPanel extends LitElement {
    ...
    return html`
      <div class="content">
        ...
        <div class="tabs">
          ...
          <button
            class="tab ${this._activeTab === "heat" ? "active" : ""}"
            @click=${() => (this._activeTab = "heat")}
          >
            ${t(this.hass, "tab.heat")}
          </button>
          <button
          ...
          <button
            class="tab ${this._activeTab === "hourlyHeat" ? "active" : ""}"
            @click=${() => (this._activeTab = "hourlyHeat")}
          >
            ${t(this.hass, "tab.hourlyHeat")}
          </button>
        </div>
        ...
        <div class="tab-content" ?active=${this._activeTab === "heat"}>
          <heat-view
            .hass=${this.hass}
            .entryId=${this._entryId}
          ></heat-view>
        ...
        <div class="tab-content" ?active=${this._activeTab === "hourlyHeat"}>
          <hourly-heat-view
            .hass=${this.hass}
            .entryId=${this._entryId}
          ></hourly-heat-view>
