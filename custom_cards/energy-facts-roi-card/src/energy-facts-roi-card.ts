...
import { EnergyFactsRoiCardConfig, RoiProjectionEntry } from "./types";
import { cardStyles } from "./styles";
import "./roi-chart";

@customElement("energy-facts-roi-card")
export class EnergyFactsRoiCard extends LitElement {
  @property({ attribute: false }) hass: any;
  @state() private _config?: EnergyFactsRoiCardConfig;

  static styles = cardStyles;

  setConfig(config: EnergyFactsRoiCardConfig): void {
    if (!config.entity) {
...
(window as any).customCards.push({
  type: "energy-facts-roi-card",
  name: "EnergyFacts ROI Card",
