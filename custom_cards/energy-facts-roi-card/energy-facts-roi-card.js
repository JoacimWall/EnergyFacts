/**
 * EnergyFacts ROI Card - Custom Lovelace Card
...
class EnergyFactsRoiCard extends HTMLElement {
  constructor() {
    super();
  ...
  _render() {
    ...
    if (!stateObj) {
      this.shadowRoot.innerHTML = `
        <ha-card>
          <style>${EnergyFactsRoiCard.CSS}</style>
...
customElements.define("energy-facts-roi-card", EnergyFactsRoiCard);
