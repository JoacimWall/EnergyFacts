"""Data update coordinator for EnergyFacts."""
...
class EnergyFactsCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    """Coordinator to manage data updates for EnergyFacts."""

    def __init__(
        self,
        hass: HomeAssistant,
        session: aiohttp.ClientSession,
        storage: EnergyFactsDatabase,
    ...
    @property
    def storage(self) -> EnergyFactsDatabase:
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        try:
            ...
            _LOGGER.exception("Unexpected error updating EnergyFacts data")
