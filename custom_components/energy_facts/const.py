"""Constants for the EnergyFacts integration."""
...
# Heat source defaults
DEFAULT_ELPATRON_THRESHOLD_W = 700
DEFAULT_HEAT_PUMP_BASE_POWER_W = 600

# Storage keys
STORAGE_VERSION = 1
STORAGE_KEY_PREFIX = "energy_facts"
